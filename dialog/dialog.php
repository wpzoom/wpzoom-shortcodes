...
<script type="text/javascript" src="<?php echo WPZOOM_Shortcodes_Plugin_Init::$assets_path; ?>/js/shortcode-generator/htmlsanitizer.js?ver=1.0.5"></script>
<script type="text/javascript" src="<?php echo WPZOOM_Shortcodes_Plugin_Init::$assets_path; ?>/js/shortcode-generator/column-control.js?ver=1.0.5"></script>
<script type="text/javascript" src="<?php echo WPZOOM_Shortcodes_Plugin_Init::$assets_path; ?>/js/shortcode-generator/tab-control.js?ver=1.0.5"></script>
<script type="text/javascript" src="<?php echo WPZOOM_Shortcodes_Plugin_Init::$assets_path; ?>/js/shortcode-generator/dialog.js?ver=1.0.5"></script>
<?php  }  else { ?>
