...
<div id="wpz-options-buttons" class="clear">
    <div class="alignleft">
        ...
        <input type="button" id="wpz-btn-cancel" class="button" name="cancel" value="<?php _e('Cancel', 'wpzoom-shortcodes-plugin'); ?>" accesskey="C" />

    </div>
    <div class="alignright">

        <input type="button" id="wpz-btn-preview" class="button" name="preview" value="<?php _e('Preview', 'wpzoom-shortcodes-plugin'); ?>" accesskey="P" />
        <input type="button" id="wpz-btn-insert" class="button-primary" name="insert" value="<?php _e('Insert', 'wpzoom-shortcodes-plugin'); ?>" accesskey="I" />
...
<div id="wpz-options" class="alignleft">
    <h3><?php echo __( 'Customize the Shortcode', 'wpzoom-shortcodes-plugin' ); ?></h3>
...
<div id="wpz-preview" class="alignleft">
    ...
    <h3><?php echo __( 'Preview', 'wpzoom-shortcodes-plugin' ); ?></h3>
...
<div id="wpz-options-error">
    <p><?php echo __( 'Your version of theme does not yet support shortcodes.', 'wpzoom-shortcodes-plugin' ); ?></p>
</div>
