...
class wzslider {
	...
	static public function loadStatic() {
		wp_enqueue_script( 'galleria', WPZOOM_Shortcodes_Init::$assets_path . '/js/galleria.js', array( 'jquery' ), null, true );
		wp_enqueue_script( 'wzslider', WPZOOM_Shortcodes_Init::$assets_path . '/js/wzslider.js', array( 'jquery' ), null, true );
	}

	static public function loadStyles() {
		wp_register_style( 'wzslider', WPZOOM_Shortcodes_Init::$assets_path . '/css/wzslider.css' );
...
function add_slider_tinymce_plugin( $plugin_array ) {
	$plugin_array['wzslider'] = WPZOOM_Shortcodes_Init::$assets_path . '/js/wzslider_button.js';
